...
{
    public partial class Green_Room : Form
    {
        int timp_adaugat;
        int last_time;
        public Green_Room()
        ...
        private void Green_Room_Leave(object sender, EventArgs e)
        {

        }

        private void Green_Room_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            this.Hide();
        }

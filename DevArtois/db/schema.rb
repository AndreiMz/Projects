...
ActiveRecord::Schema.define(version: 20180508173458) do
  ...
  create_table "beers_breweries", id: false, force: :cascade do |t|
    ...
    t.index ["beer_id"], name: "index_beers_breweries_on_beer_id"
    t.index ["brewery_id"], name: "index_beers_breweries_on_brewery_id"
  end
